...
public class IndexPage extends BaseClass
{
	...
	@FindBy(xpath = "//*[@id=\"footer_id\"]/div/div[5]/div[2]/div[1]/div[1]/ul/li[2]/a")
	...
	public void Clickon_Enter_Now_Button_One_Of_The_Instant_Raffle() throws Throwable
	{
	...
	public void Validate_By_Clicking_Raffolux_Logo() throws Throwable
	{
	...
	{
		Action.JSClick(driver, SignLink);
	...
	public End_2_End_Testcases Clickon_RaffoluxLink() throws Throwable
	{
		Action.JSClick(driver, JoinRaffoluxLink);
		//Action.Click(driver, JoinRaffoluxLink);
		return new End_2_End_Testcases();
	}
	...
	public void ClickonFooterCharityLink() throws Throwable
	{
		Action.scrollIntoView(driver, FooterCharityLink);
		Thread.sleep(2000);
		Action.Click(driver, FooterCharityLink);
		Thread.sleep(2000);
	}
